					...
					<div class="row">
						...
						<div class="col-12 col-xl-8">
							<div class="asset__item">
								<a class="asset__img" href="img/cover/cover-big.jpg"><img id="image" src="/nft/{{ $nftFile['file'] }}" alt=""></a>
								...
								<div class="share share--asset">
									...
									<a href="#" class="share__link share__link--link"><svg width="18" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
								...
								<ul class="asset__authors">
									<li>
										...
										<div class="asset__author asset__author--verified">
											...
											<a href="author/{{$nftFile['owner']}}">{{ $nftFile['owner'] }}</a>
										</div>
									</li>
									<li>
					...
					<section class="row row--grid">
						...
						<div class="col-12">
							<div class="main__carousel-wrap">
								<div class="main__carousel main__carousel--explore owl-carousel" id="explore">
									<div class="card">
										<a href="item.html" class="card__cover">
											<img src="https://wizz.network/public/nft/img/cover/cover1.jpg" alt="">
										</a>
									...
									<div class="card">
										<a href="item.html" class="card__cover">
											<img src="https://wizz.network/public/nft/img/cover/cover2.jpg" alt="">
										</a>
									...
									<div class="card">
										<a href="item.html" class="card__cover">
											<img src="https://wizz.network/public/nft/img/cover/cover3.jpg" alt="">
										</a>
									...
									<div class="card">
										<a href="item.html" class="card__cover">
											<img src="https://wizz.network/public/nft/img/cover/cover4.jpg" alt="">
										</a>
									...
									<div class="card">
										<a href="item.html" class="card__cover">
											<img src="https://wizz.network/public/nft/img/cover/cover5.jpg" alt="">
										</a>
									...
									<div class="card">
										<a href="item.html" class="card__cover card__cover--video">
											<img src="https://wizz.network/public/nft/img/cover/cover6.jpg" alt="">
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
									...
									<div class="card">
										<a href="item.html" class="card__cover">
											<img src="https://wizz.network/public/nft/img/cover/cover7.jpg" alt="">
										</a>
								...
								<button class="main__nav main__nav--prev" data-nav="#explore" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
										<path d="M17,11H9.41l3.3-3.29a1,1,0,1,0-1.42-1.42l-5,5a1,1,0,0,0-.21.33,1,1,0,0,0,0,.76,1,1,0,0,0,.21.33l5,5a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42L9.41,13H17a1,1,0,0,0,0-2Z" />
									</svg></button>
								<button class="main__nav main__nav--next" data-nav="#explore" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">

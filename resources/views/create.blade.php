                ...
                <div class="container">
                    <div class="row row--grid">
                            ...
                            <div class="author author--page">
                                <div class="author__meta">
                                    <a href="" class="author__avatar author__avatar--verified">
                                        <img id="image2" src="https://wizz.network/public/profileicon/1610710246701.png" alt="">
                                    </a>
                                    <h1 class="author__name"><a href="/nft/myProfile">afridi.12</a></h1>
                                    <h2 class="author__nickname"><a href="/nft/myProfile">EOSAccount-afridi.12</a></h2>
                                    <p id="p">All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary</p>
                                    ...
                                    <a href="#" class="author__link"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <div class="col-12 col-xl-9">
                            ...
                            <!-- title -->
                            <div class="">
                                <h2 id="h2">Create collectible item</h2>
                            </div>
                            <!-- end title -->
                            ...
                            <div class="alert alert-danger">
                                <strong id="span">Whoops! There were some problems with your input.</strong>
                                <ul id="span">
                            ...
                            <!-- end title -->
                            <!-- create form -->
                            <form class="sign__form sign__form--create" action="{{url('store')}}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-12">
                                        <h4 class="sign__title">Upload file <span id="span">*</span></h4>
                                    </div>

                                    <div class="col-12">
                                        <div class="sign__file">
                                            <label id="file1" for="sign__file-upload">e. g. Image, Audio, Video</label>
                                            <input data-name="#file1" id="sign__file-upload" name="file" class="sign__file-upload" type="file" accept="video/mp4,video/x-m4v,video/*,.png,.jpg,.jpeg">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="sign__group">
                                            <label class="sign__label" for="itemname">Item name <span id="span">*</span></label>
                                            <input id="itemname" type="text" name="name" class="sign__input" placeholder="e. g. 'Crypto Heart'" required autocomplete="off">
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <div class="sign__group">
                                            <label class="sign__label" for="description">Description <span id="span">*</span></label>
                                            <textarea id="description" name="description" class="sign__textarea" placeholder="e. g. 'After purchasing you will able to recievd...'" required autocomplete="off"></textarea>
                                        </div>
                                    </div>

                                    <div class="col-12 col-md-4">
                                        <div class="sign__group">
                                            <label class="sign__label" for="category">Category <span id="span">*</span></label>
                                            <select id="royalties" name="category" class="sign__select" required>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="sign__group">
                                            <label class="sign__label" for="royalties">Royalties <span id="span">*</span></label>
                                            <select id="royalties" name="royalties" class="sign__select" required>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="sign__group">
                                            ...
                                            <input id="size" type="text" name="length" class="sign__input" placeholder="e. g. Size" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="sign__group">
                                            ...
                                            <input id="propertie" type="text" name="dimension" class="sign__input" placeholder="Subject" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                            ...
                                            <label>
                                                <ul class="sign__radio sign__radio--single">
                                                    ...
                                                    <li>
                                                        ...
                                                        <label for="type2">Unlock one purchased</label>
                                                    </li>
                                                    <li>
                                                        <input id="type3" type="radio" name="type" value="3">
                                                        <label for="type3">Put on sale</label>
                                                    </li>
                                                </ul>
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="sign__group" id="putOnSale2">
                                            <label class="sign__label" for="price">Price <span id="span">*</span></label>
                                            <input id="price" type="number" name="price" class="sign__input" placeholder="e. g. 'Price'" autocomplete="off">
                                        </div>
                                    </div>
...
<script src="https://assets.tazor.io/nft/js/create.js"></script>